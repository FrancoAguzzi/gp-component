...
let GpExitIntent = class {
  ...
  render() {
    return (index.h("div", { onClick: e => this.handleExitIntent(e), class: { 'exit-intent-popup': true, 'visible': this.open } }, index.h("div", { class: "exit-intent-inner" }, index.h("div", { class: "ebook" }, index.h("div", { class: "gradient" }), index.h("img", { src: index.getAssetPath(this.getImageSrc()), alt: "" })), index.h("div", { class: "content" }, index.h("h2", { class: "title" }, this.caption), index.h("p", { class: "description" }, this.description), index.h("form", { onSubmit: event => this.handleSubmit(event), class: "lead-form form" }, index.h("div", { class: "form-group" }, index.h("label", { htmlFor: "email", class: "email-label" }, "E-mail"), index.h("input", { type: "email", value: this.email, onInput: event => this.handleEmailChange(event), id: "email", name: "email", class: { 'main-input': true, 'error': this.hasEmailError }, placeholder: this.getEmailPlaceholder(), required: true }), index.h("button", { type: "submit", class: "main-button--arrow link-bold", onClick: (event) => this.handleSubmitClick(event), "aria-disabled": this.getSubmitCtaDisabled() }, index.h("svg", { width: "25", height: "24", viewBox: "0 0 25 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M8.30024 7.55348H4.10008", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }), index.h("path", { d: "M8.41574 16.422L4.10008 16.4442", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }), index.h("path", { d: "M8.41574 11.9988H2", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }), index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M13.6722 12.8246L12.2946 16.4709C11.9281 17.4423 12.9152 18.3636 13.7793 17.8557L22.6417 12.6446C23.1194 12.3634 23.1194 11.6366 22.6417 11.3554L13.7793 6.14431C12.9152 5.63642 11.9271 6.55773 12.2946 7.52905L13.6722 11.1754C13.8728 11.7033 13.8728 12.2945 13.6722 12.8246Z", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }))), index.h("div", { class: "checkbox" }, index.h("input", { type: "checkbox", onClick: event => this.handleCheckboxChange(event), id: "checkbox", name: "checkbox", class: { 'main-input main-input--checkbox': true, 'error': this.hasCheckboxError }, required: true }), index.h("label", { htmlFor: "checkbox", class: "checkbox__check" }), index.h("label", { htmlFor: "checkbox", class: "checkbox__text" }, this.checkboxLabel, index.h("span", { "aria-hidden": "true" }, "*")))), index.h("div", { class: "form-group" }, index.h("button", { type: "submit", id: 'submit-cta', class: { 'main-button main-button--submit link-bold': true, 'main-button--submit--disabled': this.getSubmitCtaDisabled() }, onClick: (event) => this.handleSubmitClick(event), "aria-disabled": this.getSubmitCtaDisabled() }, this.buttonLabel))), index.h("button", { onClick: event => this.handleCloseModal(event, 0), class: "close-button desktop" }, index.h("img", { src: index.getAssetPath('./assets/img/close.svg'), alt: "Close button", class: "close-button__image" })), index.h("button", { onClick: event => this.handleCloseModal(event, 0), class: "close-button" }, index.h("p", { class: "close-button__text" }, "Agora n\u00E3o, obrigado")), index.h("button", { onClick: event => this.handleCloseModal(event, 365), class: "close-button close-button--forever" }, index.h("p", { class: "close-button__text--forever" }, "N\u00E3o mostrar novamente")))), index.h("a", { href: index.getAssetPath(this.downloadDocSrc), download: this.downloadDocName, id: "download", hidden: true })));
  }
...
exports.gp_exit_intent = GpExitIntent;
